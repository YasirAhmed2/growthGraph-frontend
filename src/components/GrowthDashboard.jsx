    ...
    return (
        <div className="w-full max-w-7xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-1000">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                ...
                <Card title="Strategic Roadmap" className="md:col-span-5" delay={200}>
            ...
            <div className="flex justify-center pt-10 pb-20">
                <button
                    onClick={onReset}
                    className="group flex items-center gap-3 px-8 py-4 rounded-full bg-white text-black font-bold tracking-wide hover:bg-slate-200 transition-all hover:scale-105 shadow-[0_0_30px_rgba(255,255,255,0.15)]"
                >
